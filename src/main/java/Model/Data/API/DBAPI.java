...
public abstract class DBAPI {
    ...
    private static final String DB_URL_TEST_DEFAULT = DBUrls.getURL(DBNames.getSQLITE(), DBFileNames.getTestDbName());
    private static final String DB_URL_MAIN_DEFAULT = DBUrls.getURL(DBNames.getSQLITE(), DBFileNames.getMainDbName());
    private static final String DB_TEST_FILENAME_DEFAULT = DBFileNames.getTestDbPath();
    private static final String DB_MAIN_FILENAME_DEFAULT = DBFileNames.getMainDbPath();
    ...
    public DBAPI(String dbUsername, String dbPassword, String dbUrl, String dbFilename, boolean testMode) {
        ...
        myDBFilename = dbFilename == null? (testMode ? DB_TEST_FILENAME_DEFAULT : DB_MAIN_FILENAME_DEFAULT) : dbFilename;
