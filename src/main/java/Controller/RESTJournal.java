...
public class RESTJournal {
    ...
    @PostMapping(value = "/logout", consumes = "text/plain;charset=UTF-8;")
    ...
    @PostMapping(value = "/verify", consumes = "text/plainn;charset=UTF-8;")
    ...
    @PutMapping(value = "/", consumes = "text/plain;charset=UTF-8;")
    ...
    @PostMapping(value = "/forgotpwd", consumes = "text/plain;charset=UTF-8;")
    ...
    @PostMapping(value = "/resetpwd", consumes = "text/plain;charset=UTF-8;")
